...
//        mVideos.add("5723ieP5VAQ");
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String shareBody = "Indulge in this exotic " + mVideos.get(curr).getName() + " at Restaurant- " + res_Name + " on Binge. https://play.google.com/store/apps/details?id=in.binge.android ";
